            ...
            <form role=" form" action="" method="post" class="f1">
                ...
                <fieldset id="p3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="precio" id="precio" class="form-control" placeholder="Asigna un Precio" aria-label="Precio" aria-describedby="basic-addon1">
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-dark ocultar" id="tbSinSubCategorias">
                            <thead>
                                <tr>
                    ...
                    <div class="f1-buttons">
                        <button type="button" class="btn btn-previous btn-secondary">Atras</button>
                        <button type="submit" class="btn btn-info ">Ver Menu</button>
                    </div>
                </fieldset>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse($categories as $category)
                            <tr>
                                <td>
                                    <a href="{{ route('categories.show', ['category' => $category]) }}">Show</a>
